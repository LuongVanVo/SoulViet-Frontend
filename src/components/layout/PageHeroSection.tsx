...
export const PageHeroSection = ({ title, subtitle, badge, children, className }: PageHeroSectionProps) => {
  return (
    <section
      className={cn(
        'relative overflow-hidden rounded-b-4xl bg-[linear-gradient(135deg,_#1A4B8E_0%,_#1d7a63_100%)] text-white shadow-lg px-6 pt-15 pb-8 sm:px-8 sm:pt-8 sm:pb-10',
        className
      )}
    >
